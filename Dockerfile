...
RUN python3 -m venv backend/backend/venv \
    && backend/backend/venv/bin/pip install --upgrade pip \
    && backend/backend/venv/bin/pip install -r backend/backend/requirements.txt
